...
namespace CursoTest
{
    public class CategoriasControllerTest
    {
        ...
        [Fact]
        public async Task Get_QuantidadeCategorias_UmaVez()
        {
        ...
        [Fact]
        public async Task Post_QuantidadeCategorias_UmaVez()
        {
            var service = new CategoriasController(_mockContext.Object);
        ...
        [Fact]
        public async Task Delete_QuantidadeCategorias_UmaVez()
        {
            var service = new CategoriasController(_mockContext.Object);
        ...
        [Fact]
        public async Task Put_QuantidadeCategorias_UmaVez()
        {
            var service = new CategoriasController(_mockContext.Object);
